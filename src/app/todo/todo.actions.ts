...
export const DELETECOMPLTED_TODOS = '[TODO] Delete all todos completed';
...
export class DeleteAllTodosCompletdAction implements Action {
  readonly type = DELETECOMPLTED_TODOS;
